...
class Button_On_Off:
    def __init__(self,
                  ...
                  text,
                  variable_ref=None,
                  on_change_monitor=None, 
                  button_font=None, 
                  button_font_inflated=None, 
                  width=120, 
                  height=40, 
                  pos=(0,0), 
                  inflation_on_press=5, 
                  border_radius=10, 
                  outline_inflation=7,
        ...
        self.variable_ref = variable_ref  # Reference to toggle variable
        self.is_on = False  # Toggle state
        self.screen = screen
    ...
    def _on_click(self):
        ...
        self.text = f"{self.base_text}: {'ON' if self.is_on else 'OFF'}"
        ...
        if self.on_change_monitor:
            self.on_change_monitor(self.is_on)
    ...
    def draw(self):
        ...
        if self.inflated:
            font = self.button_font_inflated if self.button_font_inflated else self.button_font
