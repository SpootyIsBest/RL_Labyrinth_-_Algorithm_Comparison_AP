...
def main() -> None:
    ...
    parser.add_argument("--pattern", default=os.path.join(PROJECT_ROOT, "results", "logs", "HeatMap*.csv"), help="Glob pattern for CSV files.")
    parser.add_argument("--out-video", default=os.path.join(PROJECT_ROOT, "HeatMaps_vids", "heatmap.mp4"), help="Output video path (mp4).")
    parser.add_argument("--out-dir", default=os.path.join(PROJECT_ROOT, "HeatMaps_vids", "heatmap_frames"), help="Directory to write 2D frame images.")
    parser.add_argument("--out-dir-3d", default=os.path.join(PROJECT_ROOT, "HeatMaps_vids", "heatmap_frames_3d"), help="Directory to write 3D frame images.")
